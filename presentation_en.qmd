...
format:
  revealjs:
    ...
    include-after-body: pause-videos.html
    slide-number: c/t
    progress: true
    transition: fade
    incremental: false
...
::: {.notes}
1. **C++ a nutnost rekompilace (str. 46):** Napsal jsem tam jasně vysvětlení. Parametry byly v kódu pevně zapsány jako konstanty. Přesunem do ROS 2 se nyní parametry načítají za běhu z YAML souborů, takže není potřeba rekompilace.
...
::: {.notes}
**Validita větve z grafů (str. 55):** Validitu neurčují jen vykreslené průběhy ceny, ale i nevykreslená tvrdá omezení (kloubové limity, kolize a detekce změny konfigurace), a v první větvi naráží rotační kloub polohovadla q9 na svůj kloubový limit, takže žádný bod této větve nesplní všechna omezení.
:::
